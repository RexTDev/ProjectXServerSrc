...
enum EItemMisc
{
#ifdef ENABLE_ITEM_NAME_MAX_LEN
...
#ifdef ENABLE_ITEM_EFFECT_SYSTEM
	WEARABLE_EFFECT_ARMOR	= (1 << 15),
	WEARABLE_EFFECT_WEAPON	= (1 << 16),
#endif
};
