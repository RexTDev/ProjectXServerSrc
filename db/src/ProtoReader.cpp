...
//#endif
	...
	static string arSub3[] = { "USE_POTION", "USE_TALISMAN", "USE_TUNING", "USE_MOVE", "USE_TREASURE_BOX", "USE_MONEYBAG", "USE_BAIT",
				...
				"USE_ADD_ATTRIBUTE2", "USE_RECIPE", "USE_CHANGE_ATTRIBUTE2"
...
int get_Item_WearFlag_Value(string inputString)
{
	...
	string arWearrFlag[] = {"WEAR_BODY", "WEAR_HEAD", "WEAR_FOOTS", "WEAR_WRIST", "WEAR_WEAPON", "WEAR_NECK", "WEAR_EAR", "WEAR_SHIELD", "WEAR_UNIQUE",
					"WEAR_ARROW", "WEAR_HAIR", "WEAR_ABILITY", "WEAR_COSTUME_BODY", "WEAR_COSTUME_HAIR"
#ifdef ENABLE_ACCE_COSTUME_SYSTEM
					, "WEAR_COSTUME_ACCE"
#endif
#ifdef ENABLE_MOUNT_COSTUME_SYSTEM
...
#endif
#ifdef ENABLE_ITEM_EFFECT_SYSTEM
					, "WEAR_EFFECT_ARMOR", "WEAR_EFFECT_WEAPON"
#endif
					};
...
#endif
//#ifdef ENABLE_KEYTO_CHARACTER
			, "APPLY_ATTBONUS_ELFE", "APPLY_RESIST_ELFE", "APPLY_RESIST_POLE"
//#endif
	};
