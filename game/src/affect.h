...
enum EAffectBits
{
	...
	AFF_SLOW,							// 05
	AFF_STUN,							// 06
	AFF_DUNGEON_READY,					// 07
	AFF_DUNGEON_UNIQUE,					// 08
	AFF_BUILDING_CONSTRUCTION_SMALL,	// 09
...
#ifdef ENABLE_WOLFMAN_CHARACTER
	AFF_BLEEDING = 43,					// 43
	AFF_RED_POSSESSION = 44,			// 44
	AFF_BLUE_POSSESSION = 45,			// 45
#endif
#ifdef ENABLE_KEYTO_CHARACTER_EFFEKT
	AFF_SOUL_BUFF = 46,					// 46
#endif
