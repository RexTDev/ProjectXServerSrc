...
#ifdef FULL_YANG
	ch->ChangeGold(-item_info->get_impur_price(), false);
#else
...
#ifdef FULL_YANG
	ch->ChangeGold(-(bid_price - money), false);
#else
...
#ifdef FULL_YANG
			ch->ChangeGold(restore_money, true);
#else
