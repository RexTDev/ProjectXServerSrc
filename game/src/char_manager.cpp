...
#ifdef ENABLE_WOLFMAN_CHARACTER
#define FIND_JOB_ELFE_0	(1 << 18)
#define FIND_JOB_ELFE_1	(1 << 19)
#define FIND_JOB_ELFE_2	(1 << 20)
#define FIND_JOB_ELFE		(FIND_JOB_ELFE_0 | FIND_JOB_ELFE_1 | FIND_JOB_ELFE_2)
#else
#define FIND_JOB_ELFE_0	(1 << 15)
#define FIND_JOB_ELFE_1	(1 << 16)
#define FIND_JOB_ELFE_2	(1 << 17)
#define FIND_JOB_ELFE		(FIND_JOB_ELFE_0 | FIND_JOB_ELFE_1 | FIND_JOB_ELFE_2)
#endif
#endif
