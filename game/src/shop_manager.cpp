...
{
#ifdef ENABLE_OFFLINESHOP_ONLY_FOR_VIP
	if (owner->GetGMLevel() != GM_VIP )
	{
		owner->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("SHOP_ONLY_VIP"));
		return false;
	}
	else
	{
...
#ifdef GM_BLOCK_BUY_PRIVATE_SHOP
...
#ifdef FULL_YANG
	ch->ChangeGold(dwPrice, false);
#else
	ch->PointChange(POINT_GOLD, dwPrice, false);
#endif
}

#ifdef ENABLE_SHOP_EX
