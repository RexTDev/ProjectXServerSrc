...
void exchange_packet(LPCHARACTER ch, BYTE sub_header, bool is_me, long long	 arg1, const TItemPos &arg2, long long arg3, void * pvData = NULL, DWORD dwLookVnum = 0);
void exchange_packet(LPCHARACTER ch, BYTE sub_header, bool is_me, long long	 arg1, const TItemPos &arg2, long long arg3, void * pvData, DWORD dwLookVnum)
#else
void exchange_packet(LPCHARACTER ch, BYTE sub_header, bool is_me, long long	 arg1, const TItemPos &arg2, long long arg3, void * pvData = NULL);
void exchange_packet(LPCHARACTER ch, BYTE sub_header, bool is_me, long long	 arg1, const TItemPos &arg2, long long arg3, void * pvData)
#endif
#else
#ifdef __CHANGE_LOOK_SYSTEM__
...
bool CExchange::Done()
{
	...
	{
#ifdef FULL_YANG
		GetOwner()->ChangeGold(-m_lGold, true);
		victim->ChangeGold(m_lGold, true);
#else
...
#ifdef ENABLE_CHEQUE_SYSTEM
				if (GetCompany()->m_lCheque) // 돈이 있을 때만 저장
					victim->Save();
#endif
