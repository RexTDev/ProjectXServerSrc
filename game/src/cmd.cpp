...
#ifdef ENABLE_TELEPORT_COMMAND
	#ifdef ENABLE_TELEPORT_COMMAND_ONLY_AS_GAMEMASTER
	{ "teleport",	do_teleport,	0,			POS_DEAD,	GM_IMPLEMENTOR	},
	#else
...
#ifdef ENABLE_ONLINE_COMMAND
#ifdef ENABLE_ONLINE_GM_COMMAND
...
#ifdef ENABLE_STATES_VALUE_CHANGE
	{ "ht",				do_stat_plus_amount,	POINT_HT,	POS_DEAD,	GM_PLAYER	},
	{ "iq",				do_stat_plus_amount,	POINT_IQ,	POS_DEAD,	GM_PLAYER	},
	{ "st",				do_stat_plus_amount,	POINT_ST,	POS_DEAD,	GM_PLAYER	},
	{ "dx",				do_stat_plus_amount,	POINT_DX,	POS_DEAD,	GM_PLAYER	},
#else
...
#ifdef ENABLE_GUILD_WAR_EXTENSION
	{ "guildwarextension",	do_guildwarextension,		0,			POS_DEAD,	GM_PLAYER	},
#endif
