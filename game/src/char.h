...
#ifdef ENABLE_KEYTO_CHARACTER
	POINT_ATTBONUS_ELFE = 144,
	POINT_RESIST_ELFE = 145,
	POINT_RESIST_POLE = 146,
#endif

#ifdef ENABLE_CHEQUE_SYSTEM
	POINT_CHEQUE = 147,					// point_value = 147
#endif
...
enum EBlockAction
{
	...
	BLOCK_DUELL_MODE		= (1 << 6),
#endif
#ifdef ENABLE_EXTENDED_EQUIP_VIEW
	BLOCK_VIEW_EQUIPMENT	= (1 << 7),
#endif
};
...
//		bool			IsPet() const		{ return m_bCharType == CHAR_TYPE_PET; }
		...
		const char*		RetLC_(const char* format, ...);
		BYTE			GetLanguage();
	...
	public:
		...
		// Money related
#ifdef FULL_YANG
		void			ChangeGold(long long amount,bool unused=false);

		long long		GetGold() const		{ return m_points.gold;	}
		void			SendGold(bool isLogin=false);
