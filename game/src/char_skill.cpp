...
#ifdef ENABLE_WOLFMAN_CHARACTER
	if (8 == pkSkill->dwType && JOB_ELFE == GetJob())
		return true;
#else
	if (7 == pkSkill->dwType && JOB_ELFE == GetJob())
		return true;
#endif
#endif
	if (6 == pkSkill->dwType)
...
#ifdef ENABLE_KEYTO_CHARACTER
							case WEAPON_POLE:
								iDam = iDam * (100 - pkChrVictim->GetPoint(POINT_RESIST_POLE)) / 100;
#if defined(ENABLE_KEYTO_CHARACTER) && defined(USE_ITEM_POLE_AS_BELL)
								iDam = iDam * (100 - pkChrVictim->GetPoint(POINT_RESIST_BELL)) / 100;
#endif
								break;
#endif
...
bool CHARACTER::IsUsableSkillMotion(DWORD dwMotionIndex) const
{
	...
	static DWORD s_anSkill2JobGroup[SKILL_NUM] = {
		...
		0, // empty(reserved) 168
		0, // empty(reserved) 169
		0, // empty(reserved) 170
		0, // empty(reserved) 171
		0, // empty(reserved) 172
		0, // empty(reserved) 173
		0, // empty(reserved) 174
		0, // empty(reserved) 175
#endif
		0, // empty(reserved) 176
		0, // empty(reserved) 177
		0, // empty(reserved) 178
		0, // empty(reserved) 179
		0, // empty(reserved) 180
		0, // empty(reserved) 181
		0, // empty(reserved) 182
		0, // empty(reserved) 183
		0, // empty(reserved) 184
		0, // empty(reserved) 185
		0, // empty(reserved) 186
		0, // empty(reserved) 187
		61, // 188
		61, // 189
		61, // 190
		61, // 191
...
#if defined(ENABLE_WOLFMAN_CHARACTER) && defined(ENABLE_KEYTO_CHARACTER)
	const DWORD SKILL_LIST_MAX_COUNT	= 7;
#elif defined(ENABLE_WOLFMAN_CHARACTER) && !defined(ENABLE_KEYTO_CHARACTER)
	...
	static DWORD s_anMotion2SkillVnumList[MOTION_MAX_NUM][SKILL_LIST_MAX_COUNT] =
	{
		...
		// 1번 직군 기본 스킬
#if defined(ENABLE_WOLFMAN_CHARACTER) && defined(ENABLE_KEYTO_CHARACTER)
		{   6,		1,			31,			61,			91,	170	,	188	}, //  1
		{   6,		2,			32,			62,			92,	171	,	189	}, //  2
		{   6,		3,			33,			63,			93,	172	,	190	}, //  3
		{   6,		4,			34,			64,			94,	173	,	191	}, //  4
		{   6,		5,			35,			65,			95,	174	,	192	}, //  5
		{   6,		6,			36,			66,			96,	175	,	193	}, //  6
#elif defined(ENABLE_WOLFMAN_CHARACTER) && !defined(ENABLE_KEYTO_CHARACTER)
		{   5,		1,			31,			61,			91,	170		}, //  1
		{   5,		2,			32,			62,			92,	171		}, //  2
		{   5,		3,			33,			63,			93,	172		}, //  3
		...
		// 1번 직군 마스터 스킬
#if defined(ENABLE_WOLFMAN_CHARACTER) && defined(ENABLE_KEYTO_CHARACTER)
		{   6,		1,			31,			61,			91,	170,	188	}, //  26
		{   6,		2,			32,			62,			92,	171,	189	}, //  27
		{   6,		3,			33,			63,			93,	172,	190	}, //  28
		{   6,		4,			34,			64,			94,	173,	191	}, //  29
		{   6,		5,			35,			65,			95,	174,	192	}, //  30
		{   6,		6,			36,			66,			96,	175,	193	}, //  31
#elif defined(ENABLE_WOLFMAN_CHARACTER) && !defined(ENABLE_KEYTO_CHARACTER)
		{   5,		1,			31,			61,			91,	170		}, //  26
		{   5,		2,			32,			62,			92,	171		}, //  27
		{   5,		3,			33,			63,			93,	172		}, //  28
		...
		// 1번 직군 그랜드 마스터 스킬
#if defined(ENABLE_WOLFMAN_CHARACTER) && defined(ENABLE_KEYTO_CHARACTER)
		{   6,		1,			31,			61,			91,	170,	188	}, //  51
		{   6,		2,			32,			62,			92,	171,	189	}, //  52
		{   6,		3,			33,			63,			93,	172,	190	}, //  53
		{   6,		4,			34,			64,			94,	173,	191	}, //  54
		{   6,		5,			35,			65,			95,	174,	192	}, //  55
		{   6,		6,			36,			66,			96,	175,	193	}, //  56
#elif defined(ENABLE_WOLFMAN_CHARACTER) && !defined(ENABLE_KEYTO_CHARACTER)
		{   5,		1,			31,			61,			91,	170		}, //  51
		{   5,		2,			32,			62,			92,	171		}, //  52
		{   5,		3,			33,			63,			93,	172		}, //  53
		...
		// 1번 직군 퍼펙트 마스터 스킬
#if defined(ENABLE_WOLFMAN_CHARACTER) && defined(ENABLE_KEYTO_CHARACTER)
		{   6,		1,			31,			61,			91,	170,	188	}, //  76
		{   6,		2,			32,			62,			92,	171,	189	}, //  77
		{   6,		3,			33,			63,			93,	172,	190	}, //  78
		{   6,		4,			34,			64,			94,	173,	191	}, //  79
		{   6,		5,			35,			65,			95,	174,	192	}, //  80
		{   6,		6,			36,			66,			96,	175,	193	}, //  81
#elif defined(ENABLE_WOLFMAN_CHARACTER) && !defined(ENABLE_KEYTO_CHARACTER)
		{   5,		1,			31,			61,			91,	170		}, //  76
		{   5,		2,			32,			62,			92,	171		}, //  77
		{   5,		3,			33,			63,			93,	172		}, //  78
...
#endif
#ifdef ENABLE_KEYTO_CHARACTER
	{ {	188,189,190,191,192,193	}, {	0,	0,	0,	0,	0,	0	} },
#endif
};
...
const DWORD GetRandomSkillVnum(BYTE bJob)
{
	...
	do
	{
		...
		if (tmpJob==JOB_WOLFMAN)
			continue;
#endif
#if defined(ENABLE_KEYTO_CHARACTER) && !defined(USE_ELFE_BOOKS)
		if (tmpJob==JOB_ELFE)
			continue;
#endif
